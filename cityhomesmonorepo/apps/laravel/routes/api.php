...
Route::post('add-image', \App\Http\Controllers\API\UnitImageController::class);


// Routes for messages
Route::get('see-contact-information', [ContactUsController::class, 'index']);
Route::delete('delete-contact-information/{id}', [ContactUsController::class, 'deleteMessage']);
Route::post('add-contact-information', [ContactUsController::class, 'sendMessageToAdmin']);
...
route::get('getAuthData', [CityHomePayment::class, 'getAccessToken']);
